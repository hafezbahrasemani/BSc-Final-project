...
class TrainGAN:
    ...
    def train_step(self, passwords, epoch):
        ...
        with tf.GradientTape() as gen_tape, tf.GradientTape() as disc_tape:
            ...
            generated = tf.reshape(generated_passwords,
                                   [GANConfig.NOISE_INPUT_SIZE, GANConfig.OUTPUT_SEQ_LENGTH, self.vocab_size])
            ...
            if epoch % 10 == 0:
                ...
                self.save_generated_passwords(generated_argmax,
                                              f"generated-password_epoch-{str(epoch)}_{current_time_str}")
        ...
        self.history.append({"D": disc_loss, "G": gen_loss})
    ...
    def train(self, dataset, char2id, epochs):
        ...
        print(f'Training time in minutes: {elapsed / 60}')
